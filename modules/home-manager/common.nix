...
let
  ...
  claudeFiles = import ./ai-cli/claude.nix {
    inherit config pkgs lib claude-code-plugins claude-cookbooks claude-plugins-official anthropic-skills ai-assistant-instructions claude-code-settings-schema;
  };
